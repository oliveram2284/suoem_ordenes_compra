...
<html lang="en">
    ...
    <body class='bg-light'>
        ...
        <div class="page-wrapper" id="page-wrapper">
            ...
            <main class="content">
                <?php echo form_open('login/comercio',array('method'=>'post')); ?>
                        ...
                        <div class=' mt-60 mb-60  col-lg-6 col-md-6 col-sm-12 ml-auto mr-auto'>
                            <div class="bg-white shadow-sm overflow-hidden rounded">
                                <div class="p-4 text-center bg-white text-dark">
                                    ...
                                    <h5 class='text-center h5 pt-10 mb-0 text-dark'>Bienvenido Usuario De Comercio, Inicie Sesión!</h5>
                                </div>
                                <div class="p-3 pt-30 pb-30">
                                        ...
                                        <div class="input-icon-group">
                                            <div class="d-flex flex flex-row">
                                                <label class="flex d-flex mr-auto" for='pass'>Usuario de Comercio</label>
