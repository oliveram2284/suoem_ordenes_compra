        ...
        <div class="portlet-box portlet-gutter ui-buttons-col mb-30">
            <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                <div class="flex d-flex flex-column">
                    <h3>Formulario de Usuario de Comercio</h3> 
             ...
             <?php echo validation_errors(); ?>
                ...
                <?php echo form_open($action,array('method'=>'post')); ?>
                    ...
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Usuario de Comercio</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control  <?php echo (form_error('username')!='')?'error':''?>" id="username" name="username" value="<?php echo set_value('username',$comercio['username']); ?>" placeholder="Nombre de Usuario">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo set_value('firstname',$comercio['firstname']); ?>" placeholder="Nombre">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo set_value('lastname',$comercio['lastname']); ?>" placeholder="Apellido">
                        </div>
                    </div>
